...
class MenusController extends AdminController
{
    ...
    public function __construct(MenusRepositories $m_rep, ArticlesRepositories $a_rep,PortfoliosRepositories $p_rep)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        $this->content = view(env('THEME').'.admin.menus_create_content')->with(['type'=>$type,'menus'=>$menus,'categories'=>$list,'articles'=>$articles,'filters' => $filters,'portfolios' => $portfolios])->render();
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(\Pako\Menu $menu)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request,\Pako\Menu $menu)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(\Pako\Menu $menu)
    {
